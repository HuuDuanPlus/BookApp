...
import joshuuduan.giaoly.bookapp.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.backBtnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //handle clicj, go to register screen
